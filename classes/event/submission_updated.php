...
/**
 * The assignsubmission_edulegit submission_updated event.
 *
...
/**
 * The assignsubmission_edulegit submission_updated event class.
 *
 * @package   assignsubmission_edulegit
 * @author    Alex Crosby <developer@edulegit.com>
 * @copyright @2024 EduLegit.com
...
class submission_updated extends \mod_assign\event\submission_updated {
    ...
    public function get_description() {
        $descriptionstring = "The user with id '$this->userid' updated Edulegit submission " .
